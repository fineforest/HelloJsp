...
<head>
	...
	--------------------------------------------------------------------------%>
	<link rel="stylesheet" href="Index.css?version=1.6"/>
	<style type="text/css">
		/* -----------------------------------------------------------------
			HTML Page 스타일시트
		   ----------------------------------------------------------------- */
...
<%
	...
	String sMenuItem5 = "NBoard/NBoardList.jsp?NBoardPageNum=1&NBoardVector=First";
	String sMenuItem6 = "NBoard/NBoardDetail.jsp?NBoardPageNum=1&JopStatus=Insert";
	// ---------------------------------------------------------------------
	...
	// ---------------------------------------------------------------------
	// 쿠키 초기화
	String IsCheck = request.getHeader("Cookie");
...
<body class="Body">
	...
	<form name="form1" action="" method="post">
		...
		----------------------------------------------------------------------%>
		<ul class="Menu1">
			<li class="MenuItem"><a class="Link" href="<%=sMenuItem1 %>">기본 페이지 - JSP 예시</a></li>
		</ul>
		<hr class="Line">
		<ul class="Menu2">
			<li class="MenuItem"><a class="Link" href="<%=sMenuItem2 %>">사원검색 - (Use JSP/Beans/ResultSet)</a></li>
			<li class="MenuItem"><a class="Link" href="<%=sMenuItem3 %>">사원검색 - (Use JSP/Beans/ArrayList)</a></li>
			<li class="MenuItem"><a class="Link" href="<%=sMenuItem4 %>">사원검색 - (Use JSP/Servlet/ResultSet)</a></li>
		</ul>
		<hr class="Line">
		<ul class="Menu3">
			<li class="MenuItem"><a class="Link" href="<%=sMenuItem5 %>">-게시판- (Use JSP/Beans/Servlet/ResultSet)</a></li>
			<li class="MenuItem"><a class="Link" href="<%=sMenuItem6 %>">-글쓰기- (Use JSP/Beans/Servlet/ResultSet)</a></li>
		</ul>
		<hr class="Line">
	</form>
	<%----------------------------------------------------------------------
