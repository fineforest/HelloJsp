...
<head>
    ...
    <title>JSP-Modal Prototype Page</title>
	<%----------------------------------------------------------------------
	[HTML Page - 스타일쉬트 구현 영역]
	[외부 스타일쉬트 연결 : <link rel="stylesheet" href="Hello.css?version=1.1"/>]
	--------------------------------------------------------------------------%>
	<link rel="stylesheet" href="CSS/ModalMain.css?version=1.1"/>
	<style type="text/css">
		/* -----------------------------------------------------------------
			HTML Page 스타일시트
		   ----------------------------------------------------------------- */
	...
	--------------------------------------------------------------------------%>
	<script type="text/javascript" src="JS/ModalMain.js"></script>
...
<body class="Body">
	...
	<form name="form1" action="" method="post">
		...
		<div id="divModalParent">
			...
			----------------------------------------------------------------------%>
			<hr class="Line">
			<p  class="Title">Hello Modal ProtoType</p>
			<hr class="Line">
			<%------------------------------------------------------------------
				메인 페이지
			----------------------------------------------------------------------%>
			...
			<div class="Menu" id="frameMain1">
				...
				<input class="Button" type="button" name="btnHelloSetCookie"	value="메시지 출력"		onclick="HelloSetCookie()">&nbsp;&nbsp;
				<input class="Button" type="button" name="btnShowModalWindow"	value="모달 창 열기"	onclick="ShowModalWindow('ModalPopup.jsp')">
			</div>
			<hr class="Line">
	    </div>
		<%------------------------------------------------------------------
